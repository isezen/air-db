"""
airpy database object
~~~~~~~~~~~~~~~~~~~~~
Airpy Environmental Database Project

:version: 0.2
:github: https://github.com/isezen/airpy
:docs: https://github.com/isezen/airpy
...
class Options(metaclass=_Singleton):  # pylint: disable=R0903
    ...
    def db_path(self):
        ...
        try:
            ...
            try:
                db_path = os.environ['AIRPY_DB_PATH']
            except KeyError:
...
class Database:
    """
    This class is used to connect to a specific airpy database.
    """
